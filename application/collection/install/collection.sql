...
CREATE TABLE `yzn_collection_node` (
  ...
  `url_range` char(50) NOT NULL DEFAULT '' COMMENT '列表url切片选择器',
  `url_rule1` char(50) NOT NULL DEFAULT '' COMMENT '列表url选择器规则',
  `url_rule2` char(50) NOT NULL DEFAULT '' COMMENT '列表url属性规则',
  `url_rule3` char(50) NOT NULL DEFAULT '' COMMENT '列表url过滤器规则',
  `url_rule4` char(50) NOT NULL DEFAULT '' COMMENT '列表url选择器规则',
  `url_rule5` char(50) NOT NULL DEFAULT '' COMMENT '列表url属性规则',
  `url_rule6` char(50) NOT NULL DEFAULT '' COMMENT '列表url过滤器规则',
