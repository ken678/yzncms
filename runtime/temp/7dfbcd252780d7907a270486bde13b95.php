<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"E:\yzncms/apps/admin\view\login.html";i:1490661139;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="login-layout">
    ...
    <form action="<?php echo url('admin/index/checkLogin'); ?>" method="post" id="form_login">
        ...
        <div class="avatar"><img src="__ROOT__/apps/admin/view/images/login/admin.png" alt=""></div>
...
<script src="__ROOT__/apps/admin/view/js/jquery.progressBar.js" type="text/javascript"></script>
