...
2.提交1款免费开源模块（需审核）
3.提交3款免费开源插件（需审核）
4.定期举行授权活动（预计2021.1.1）
（满足条件即可拉进官方授权群，享受丰富的插件,模块,各种资源及便捷的交流学习）
```
...
## [截图预览]
![输入图片说明](https://images.gitee.com/uploads/images/2020/1125/083302_1b68b20d_555541.gif "GIF-min.gif")
