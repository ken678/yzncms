define(['jquery', 'layui'], function($, layui) {
	...
	var pearTheme = {};
	pearTheme.autoHead = false;

	pearTheme.changeTheme = function (target, autoHead) {
	...
	pearTheme.colorSet = function(color, second) {
		var style = '';
		...
		style += '.pear-admin .layui-logo i{color:' + color + '!important;}';
