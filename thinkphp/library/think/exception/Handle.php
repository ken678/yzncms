...
class Handle
{
    ...
    public function report(Exception $exception)
    {
        if (!$this->isIgnoreReport($exception)) {
            ...
            if (Container::pull('app')->config('log.record_trace')) {
    ...
    protected function renderHttpException(HttpException $e)
    {
        ...
        $template = Container::pull('app')->config('http_exception_template');
    ...
    protected function convertExceptionToResponse(Exception $exception)
    {
        ...
        if (Container::pull('app')->isDebug()) {
            ...
            if (!Container::pull('app')->config('show_error_msg')) {
                // 不显示详细错误信息
                $data['message'] = Container::pull('app')->config('error_message');
            }
        }
        ...
        ob_start();
        extract($data);
        include Container::pull('app')->config('exception_tmpl');
