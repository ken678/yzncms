...
INSERT INTO `yzn_field_type` VALUES ('switch', '开关', 5, 'tinyint(2) UNSIGNED NOT NULL', 0, 0, 'isBool');
...
INSERT INTO `yzn_field_type` VALUES ('image', '单张图', 10, 'int(5) UNSIGNED NOT NULL', 0, 0, 'isNumber');
...
INSERT INTO `yzn_field_type` VALUES ('number', '数字', 13, 'int(10) UNSIGNED NOT NULL', 0, 0, 'isNumber');
...
INSERT INTO `yzn_field_type` VALUES ('file', '单文件', 18, 'int(5) UNSIGNED NOT NULL', 0, 0, 'isNumber');
