...
class Sql
{
     ...
     */
    public static function getSqlFromFile(string $sql_file = '', bool $string = false, array $replace = []): array|false|string
    {
        ...
        // 分割语句
        return self::parseSql($handle, $string, $replace);
    }
     ...
     * @return array|string|string[] 除去注释之后的sql语句数组或一条语句
     */
    public static function parseSql(string $content = '', bool $string = false, array $replace = []): array|string
    {
        // 被替换的前缀
        $from = '';
        // 要替换的前缀
