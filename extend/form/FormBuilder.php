...
EOD;
    ...
    protected function uploader($name = null, $value = null, $inputAttr = [], $uploadAttr = [], $chooseAttr = [], $previewAttr = [])
    {
        ...
        $uploadBtn = $upload ? $this->button('<i class="iconfont icon-upload-line"></i> ' . '上传', array_merge($options, $uploadAttr)) : '';
        ...
        $chooseBtn = $choose ? $this->button('<i class="iconfont icon-list-unordered"></i> ' . '选择', array_merge($options, $chooseAttr)) : '';
